...
<html>
    <head>
        ...
        <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo$row["id"]?>">Delete</button>
            ...
            <div class="col-sm-10">
            <input type="radio" class="form-control" name="Day" value="<?php echo$row["Day"]?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="radio" class="form-control" name="Session" value="<?php echo$row["Session"]?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="radio" class="form-control" name="Experience" value="<?php echo$row["Experience"]?>">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            <label for="mood" class="col-sm-2 col-form-label">Mood</label>
            <div class="col-sm-10">
            <input type="mood" name="Mood" class="form-control" value="<?php echo$row["Mood"]?>">
            </div>
        </div>

        <div class="mb-3 row">
            <label for="nutrition" class="col-sm-2 col-form-label">Nutrition</label>
            <div class="col-sm-10">
            <input type="text" name="Mood" class="form-control" value="<?php echo$row["Mood"]?>">
            </div>
        </div>
